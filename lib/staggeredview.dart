...
import 'package:note/notehandler.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'package:note/sqlfilteHandler.dart';
import 'package:note/staggeredTiles.dart';
...
class StaggeredGridPage  extends StatefulWidget{
  final notesViewType;
  const StaggeredGridPage({Key key ,this.notesViewType}) :
  super(key:key);
  @override
...
class _StaggeredGridPageState extends  State<StaggeredGridPage> {
  ...
  void initState() {
   ...
   List<StaggeredTile> _titlesForView() { // Generate staggered tiles for the view based on the current preference.
...
EdgeInsets _paddingForView(BuildContext context){
  ...
  MyStaggeredTile _titleGenerator(int i){
